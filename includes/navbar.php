...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center">
        <div class="sidebar-brand-icon rotate-n-15">
            <img src="https://img.icons8.com/bubbles/50/000000/manager.png"/>    
        </div>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="dasboad.php">
    ...
    <li class="nav-item">
        <a class="nav-link" href="dsadmin.php">
            <i ><img src="https://img.icons8.com/color/48/000000/blocked-account-male.png"/></i>
            <span>Tài khoản</span>
        </a>
    </li>
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="dsdonhang.php">
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">Chọn "Đăng xuất" nếu bạn muốn thoát khỏi tài khoản này</div>
